...
// =====================================================
// COUNTDOWN TIMER - Updated for Feb 4, 2026 at 11 PM
// =====================================================
...
function initTimeline() {
  ...
  if (timelineProgress && storySection) {
    window.addEventListener("scroll", () => {
      ...
      // Animate timeline nodes as progress bar passes them
      const events = document.querySelectorAll('.timeline-event')
      events.forEach(event => {
        const eventTop = event.getBoundingClientRect().top
        // Activate when the node is well within the viewport (approx where the line fills)
...
// =====================================================
// BLESSINGS WALL - Updated for Tapan & Priyanka
// =====================================================
...
// =====================================================
// RSVP FORM - Updated for new events
// =====================================================
